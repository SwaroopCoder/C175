...
AFRAME.registerComponent("markerhandler", {
  ...
  tick: function () {
    if (elementsArray.length > 1) {
      ...
      if (length === 3) {
        var marker1 = document.querySelector(`#marker-${elemantArray[0].barcode_value}`)
        var marker2 = document.querySelector(`#marker-${elemantArray[1].barcode_value}`)
        var marker3 = document.querySelector(`#marker-${elemantArray[2].barcode_value}`)
